        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="owl-carousel controlls-over" data-plugin-options='{"items": 1, "singleItem": true, "navigation": true, "pagination": true, "transitionStyle":"fadeUp"}'>
                    <div>
                        <img class="img-responsive" src="/img/eventos/baja_resolucion/800x600/equipo.jpg" width="555" height="311" alt="">
                    </div>
                    <div>
                        <img class="img-responsive" src="/img/eventos/baja_resolucion/800x600/equipo2.jpg" width="555" height="311" alt="">
                    </div>
                    <div>
                        <img class="img-responsive" src="/img/eventos/baja_resolucion/800x600/equipo3.jpg" width="555" height="311" alt="">
                    </div>
